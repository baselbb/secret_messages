...
def menu():
  ...
  # first get required additional input if required from a cipher and hold in paramters
  # formula creates instance for the cipher using paramters
  # if encrypt is chosen, usertext and method choice is passed to the onetime pad cipher
  # one time pad cipher text is passed to encrypt method in cipher class
  # if decrypt is chosen, text is passed to the cipher method decrypt first then to onetimepad cipher
